...
- Install package without build isolation (fast rebuilds): `uv sync --inexact --no-dev --no-build-isolation-package mqt-qusat`
...
- NEVER edit `.pyi` files in `python/mqt/qusat/` manually; they are auto-generated by nanobind stubgen.
