...
try:
    version = metadata.version("mqt.qusat")
except ModuleNotFoundError:
    msg = "mqt.qusat must be installed to build the documentation"
...
modindex_common_prefix = ["mqt.qusat."]
...
html_theme_options = {
    ...
    "source_repository": "https://github.com/munich-quantum-toolkit/qusat/",
    "source_branch": "main",
    ...
    "footer_icons": [
        ...
        {
            "name": "PyPI",
            "url": "https://pypi.org/project/mqt.qusat/",
            "html": "",
